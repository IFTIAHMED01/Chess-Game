...
public class Player {
    ...
    int countP2 = 0;// Use this for Black(Enpassant)
    int countP3 = 0;// Use this for Black(Enpassant)
    int countP4 = 0;// Use this for Black(Enpassant)
    int countP5 = 0;// Use this for Black(Enpassant)
    int countP6 = 0;// Use this for Black(Enpassant)
    int countP7 = 0;// Use this for Black(Enpassant)
    int countP8 = 0;// Use this for Black(Enpassant)
    ...
    public boolean Checkmate1(char[][] eri, int m1, int n1) {
    ...
    public boolean Checkmate(char[][] eri, int x1, int y1) {
        for (int i = 0; i < eri.length; i++) {
            for (int j = 0; j < eri.length; j++) {
                if (eri[i][j] == 'I') {
                    return false;
...
//     if((x1-1>=0&&x1+1<eri.length&&y1-1>=0&&y1+1<eri.length)&&
//        (eri[x1-1][y1]!='q'||eri[x1-1][y1]!='r')&&
//        (eri[x1+1][y1]!='q'||eri[x1+1][y1]!='r')&&
//        (eri[x1][y1-1]!='q'||eri[x1][y1-1]!='r')&&
//        (eri[x1][y1+1]!='q'||eri[x1][y1+1]!='r')&&
//        (eri[x1+1][y1-1]!='b'||eri[x1+1][y1-1]!='q'||eri[x1+1][y1-1]!='p')&&
//        (eri[x1+1][y1+1]!='b'||eri[x1+1][y1+1]!='q'||eri[x1+1][y1+1]!='p')&&
//        (eri[x1-1][y1-1]!='b'||eri[x1-1][y1-1]!='q')&&
//        (eri[x1-1][y1+1]!='b'||eri[x1-1][y1+1]!='q')){
//     
//          return true;
//     }
...
//        int steps = input.nextInt();
        if (choose == 0) {
            ...
            //   turns=1;
            //   switchPlayer(eri);
            if (Checkmate1(eri, m1, n1) == false) {
                //System.out.println("1234567898765432");
                turns = 1;
                switchPlayer(eri);
            } else if (Checkmate1(eri, m1, n1) == true) {
                System.out.println("Checkmate! White King wins!!!");
                turns = 2;
                switchPlayer(eri);
            }
        }
...
//        int steps = input.nextInt();
        ...
        if (choose == 0) {
            ...
            if (Checkmate(eri, x1, y1) == false) {
                //System.out.println("1234567898765432");
                turns = 0;
                switchPlayer(eri);
            } else if (Checkmate(eri, x1, y1) == true) {
                System.out.println("Checkmate. Black king wins!!!");
                turns = 2;
                switchPlayer(eri);
            }
        }
